...
export default function SectionHeader({
  ...
  return (
    <div className="flex items-center justify-end gap-x-3 gap-y-2 sm:gap-x-7 flex-wrap sm:flex-nowrap py-2 mt-5 mb-2 px-1 text-right">
      <div className="hidden sm:block w-full h-px bg-strong" />
